...
: "${NEXT_PUBLIC_API_BASE_URL:=http://langgraph-backend:8000}"
...
export NAMESPACE BACKEND_IMAGE FRONTEND_IMAGE LLAMA_API_URL LLAMA_MODEL NEO4J_URI NEO4J_USER NEO4J_PASSWORD NEO4J_DATABASE NEXT_PUBLIC_API_BASE_URL
